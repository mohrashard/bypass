...
# Fix NVENC usage in stage_cinematic_grade (the fallback one)
...
'''
    ...
    print('COULD NOT FIND SHIFT_X REPLACE TARGET')
...
if zoom_start != -1:
    ...
    print('COULD NOT FIND ZOOM SCALE REPLACE TARGET')
...
if stab_ff_start != -1:
    ...
    print('COULD NOT FIND FF_STAB REPLACE TARGET')

with open(r'c:\Projects\capcut-bypass\ai_engine\pipeline.py', 'w', encoding='utf-8') as f:
    f.write(content)
print('Success!')
